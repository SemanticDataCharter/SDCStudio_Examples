...
"""
List View for statepopulation instances.
...
class InstanceListView(ListView):
    ...
    List view for Statepopulation instances.
    """
    model = StatepopulationInstance
    template_name = 'statepopulation/instance_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['validation_choices'] = StatepopulationInstance.VALIDATION_STATUS_CHOICES
        context['rdf_status_choices'] = StatepopulationInstance.RDF_SYNC_STATUS_CHOICES
        return context
