...
"""
Detail View for statepopulation instances.
...
class InstanceDetailView(DetailView):
    """
    Detail view for a single Statepopulation instance.
    """
    model = StatepopulationInstance
    template_name = 'statepopulation/instance_detail.html'
...
class InstanceDownloadXMLView(View):
    ...
    def get(self, request, pk):
        ...
        try:
            instance = StatepopulationInstance.objects.get(pk=pk)
