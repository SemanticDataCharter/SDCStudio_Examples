"""
Django admin configuration for TestData3.
...
@admin.register(TestData3Instance)
class TestData3InstanceAdmin(admin.ModelAdmin):
    """
    Admin interface for TestData3 instances.
